...
class UserVerifiedModel extends Model
{
    ...
    //2017.9.8添加统一信用号数据表映射
    protected $fields = array('id', 'uid', 'usergroup_id', 'user_verified_category_id', 'company', 'realname', 'idcard','company_tyidcard', 'phone', 'info', 'verified', 'attach_id');
